...
class BigDropoutFlexibleVideoModel(nn.Module):
    def __init__(self,
                 encoder_dim=768,
                 heads=4,
        ...
        # Transformer encoder
        encoder_layer = nn.TransformerEncoderLayer(d_model=encoder_dim, nhead=heads, dropout=dropout, batch_first=False)
