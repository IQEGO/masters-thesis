...
def run_training(params, group_name):
    ...
    config_path = os.path.join(root_dir, 'configs', 'run_config.json')
    ...
    try:
        ...
        print(f"Error loading run_config.json: {e}")
        run_config = {}

    # Update the run_config with the parameters for this run
    run_config.update(params)
    run_config['group'] = group_name
    run_config['mode'] = 'local'

    # Save the updated run_config
